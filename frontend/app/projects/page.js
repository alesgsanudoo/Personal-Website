    ...
    return (
        <main className="flex flex-col">
            <div
                ...
                <h1 className="text-3xl md:text-6xl lg:text-6xl mt-5 font-bold bg-gradient-to-r from-blue-500 to-blue-50 text-transparent bg-clip-text select-none">Projects
                    List</h1>
